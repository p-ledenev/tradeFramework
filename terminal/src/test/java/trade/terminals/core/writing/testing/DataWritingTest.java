package trade.terminals.core.writing.testing;
...
public class DataWritingTest {
    ...
    String content = "USD-9.15\tFORTS_USD_DEV_1\tAveragingStrategy\t1\t0.0145\t27\t0.5\n" +
            ...
            "\n" +
            "USD-9.15\tFORTS_USD_APP_1\tApproximationStrategy\t1\t0.0145\t2000\t0.5\n" +
